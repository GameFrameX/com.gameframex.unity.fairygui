...
**FairyGUI 컴포넌트 (FairyGUI Component)** - Game Frame X 프레임워크 내에서 FairyGUI 통합을 위한 인터페이스를 제공합니다.
...
1. `manifest.json`의 `dependencies`에 다음 내용을 추가:
   ...
   ```
2. Unity의 `Packages Manager`에서 `Git URL`을 사용하여 추가: `https://github.com/AlianBlank/com.gameframex.unity.fairygui.git`
...
변경 로그는 [Releases](https://github.com/gameframex/com.gameframex.unity.fairygui/releases)에서 확인하세요.
