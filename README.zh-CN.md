...
1. 直接在 `manifest.json` 的 `dependencies` 节点下添加以下内容：
   ...
   ```
2. 在 Unity 的 `Packages Manager` 中使用 `Git URL` 的方式添加库，地址为：`https://github.com/AlianBlank/com.gameframex.unity.fairygui.git`
...
查看 [Releases](https://github.com/gameframex/com.gameframex.unity.fairygui/releases) 了解更新日志。

## 开源协议

本项目基于 [MIT 协议](https://github.com/gameframex/com.gameframex.unity.fairygui/blob/main/LICENSE) 开源。
